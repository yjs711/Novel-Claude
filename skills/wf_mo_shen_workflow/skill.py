...
<rules>
按起点编辑标准检查以下6项：
1. 上帝视角旁白/作者跳出来解释总结/不是A而是B句式 — 这些是P0红线
2. 寄生视角是否锁死主角感官 — 禁止透视配角内心
3. 章末钩子是否断在精彩处 — 平稳收束=死罪
4. 说教句式：原来…/这说明…/他明白了…/人生就是这样…
5. 对话是否像活人说的 — 不说教、不哲学讨论、不解释剧情
6. 是否有"人味" — 真实情绪颗粒度，不是华丽词藻
</rules>
...
1. 删除不是A而是B句式及其所有变体
2. 删除上帝视角旁白解释
3. 情绪不直说 — 用身体反应/环境替代/动作留白
4. 锁死寄生视角 — 禁止透视配角内心
5. 删除AI模板词：前所未有/一股/猛地一震/倒吸一口凉气/心头一震/顿时/不由得/忍不住
</rules>
...
6维评分(每维0-100):
  1. pacing — 节奏是否紧凑，无拖沓
  2. hook_strength — 章末钩子强度
  3. ai_flavor — AI味浓度(越低越好)，>30必须重写
  4. dialogue_naturalness — 对话是否像活人
  5. sensory_richness — 感官细节密度
  6. reader_retention — 读者读完本章是否想点下一章

P0红线: ai_flavor>30 → 重写。hook_strength<40 → 重写。
</rules>

<output_format>
JSON: {"final_score":85,"dimensions":{"pacing":80,"hook_strength":88,"ai_flavor":15,"dialogue_naturalness":83,"sensory_richness":75,"reader_retention":82},"passed":true,"remaining_issues":[]}
</output_format>"""
